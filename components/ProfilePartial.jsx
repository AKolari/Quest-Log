...
if(loading){
  ...
  <svg aria-hidden="true" className=" w-4  h-4 text-White-Smoke animate-spin dark:text-White-Smokel  fill-black " viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
