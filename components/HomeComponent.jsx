...
if(!loaded){
    ...
    <div role="status" className=" col-span-5 flex justify-center items-center " >
        <svg aria-hidden="true" class=" w-40  h-40 text-White-Smoke animate-spin dark:text-White-Smokel  fill-black " viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
return <>
<div className="flex  m-12  flex-col items-center justify-between col-span-4 text-white  ">
